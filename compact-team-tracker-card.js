console.log("!!! TEAM TRACKER v2.0.9-beta8 !!!");
  ...
  renderMatch(entityObj, t) {
    ...
    return html`
      <div class="card-wrapper">
        ...
        <!-- HIER: Nur dieser mittlere Streifen erhält customStyle -->
  ...
  renderUltraMatch(entityObj, t) {
    ...
    return html`
      <div class="ultra-wrapper ${s === 'IN' ? 'live-border' : ''}">
        <div class="ultra-middle" style="${customStyle}">
  ...
  static get styles() {
    return css`
      ha-card { 
        ...
        padding-bottom: 8px; 
        position: relative; 
        background: var(--ha-card-background, var(--card-background-color, #181d28));
      }
      .card-wrapper { 
        width: 100%; 
        max-width: 100%; 
      ...
      /* Mittlerer Streifen mit Teamfarbe */
      .content { 
        display: flex; 
        align-items: center; 
        justify-content: space-between; 
      ...
      .ultra-wrapper { display: flex; width: 100%; box-sizing: border-box; background: transparent; }
      .ultra-middle { display: flex; align-items: center; justify-content: space-between; padding: 10px 16px; width: 100%; box-sizing: border-box; transition: background-color 0.3s ease; }
      ...
      .slider-nav { display: flex; align-items: center; justify-content: space-between; padding: 4px 12px 0; margin-top: 4px; background: transparent; }
